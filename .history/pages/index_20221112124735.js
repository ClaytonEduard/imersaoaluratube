...
import {Image} from '../src/components/img/ilya-pavlov-OqtafYT5kTw-unsplash.jpg'
function HomePage () {
...
function Header () {
  return (
    <>
      <Image
        source={`/src/components/img/futuristic-smart-city-with-5g-global-network-technology.jpg`}
      ></Image>
      <StyledHeader>
